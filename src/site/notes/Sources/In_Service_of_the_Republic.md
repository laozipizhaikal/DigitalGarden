...
1. [[#In Service of the Republic|In Service of the Republic]]
2. [[#What objectives of public policy are appropriate?"|What objectives of public policy are appropriate?"]]
	1. [[#What objectives of public policy are appropriate?"#Traditional Thinking:|Traditional Thinking:]]
	2. [[#What objectives of public policy are appropriate?"#Proposed thinking|Proposed thinking]]
3. [[#People respond to incentives|People respond to incentives]]
				1. [[#Deploy incentives with care - caution in setting up high-powered incentives”|Deploy incentives with care - caution in setting up high-powered incentives”]]
				2. [[#Caution in setting up incentives around statistical measures|Caution in setting up incentives around statistical measures]]
				3. [[#People’s responses to incentives can be wonky|People’s responses to incentives can be wonky]]
			1. [[#cost of acquiring and processing information|cost of acquiring and processing information]]
			2. [[#thinking across long time horizons|thinking across long time horizons]]
4. [[#Price System|Price System]]
	1. [[#Price System#Four forces of stabilization —|Four forces of stabilization —]]
5. [[#More competition Always|More competition Always]]
	1. [[#More competition Always#Creative destruction and the death of firms - needed|Creative destruction and the death of firms - needed]]
					1. [[#People’s responses to incentives can be wonky#Business cycle fluctuations and firm failure|Business cycle fluctuations and firm failure]]
	2. [[#More competition Always#The government as a source of market power|The government as a source of market power]]
6. [[#General Equilibrium Effects|General Equilibrium Effects]]
7. [[#Go to the root cause, use the smallest possible force|Go to the root cause, use the smallest possible force]]
8. [[#Redistribution is fraught with trouble|Redistribution is fraught with trouble]]
	1. [[#Redistribution is fraught with trouble#Difficulties with paternalism|Difficulties with paternalism]]
	2. [[#Redistribution is fraught with trouble#Poverty will not be solved by redistribution|Poverty will not be solved by redistribution]]
					1. [[#People’s responses to incentives can be wonky#Loss of focus weakens accountability|Loss of focus weakens accountability]]
9. [[#Private Solutions for Market Failiures|Private Solutions for Market Failiures]]
10. [[#Calculations in Public Policy|Calculations in Public Policy]]
11. [[#Ask the right question|Ask the right question]]
					1. [[#People’s responses to incentives can be wonky#Tax|Tax]]
					2. [[#People’s responses to incentives can be wonky#Deficit|Deficit]]
					3. [[#People’s responses to incentives can be wonky#Formal process helps|Formal process helps]]
12. [[#Decentralisation|Decentralisation]]
				1. [[#thinking across long time horizons#Where to be careful about decentralisation|Where to be careful about decentralisation]]
13. [[#Evolutionary Change for the society, revolutionary change for the government|Evolutionary Change for the society, revolutionary change for the government]]
14. [[#Cross the river by feeling the stones|Cross the river by feeling the stones]]
15. [[#be careful of isomorphic mimicry|be careful of isomorphic mimicry]]
16. [[#Free-riding on state capacity outside India|Free-riding on state capacity outside India]]
17. [[#Public policy work is a test match, not an IPL.|Public policy work is a test match, not an IPL.]]
	1. [[#Public policy work is a test match, not an IPL.#Policymaking on the election clock”|Policymaking on the election clock”]]
	2. [[#Public policy work is a test match, not an IPL.#Playing the long game|Playing the long game]]
18. [[#What is hard and what is easy|What is hard and what is easy]]
	1. [[#What is hard and what is easy#Four dimensions of complexity|Four dimensions of complexity]]
	2. [[#What is hard and what is easy#Solutions that reduce complexity in some dimensions|Solutions that reduce complexity in some dimensions]]
	3. [[#What is hard and what is easy#Learn to walk before you run Once|Learn to walk before you run Once]]
19. [[#Confident policymakers work in the open|Confident policymakers work in the open]]
		1. [[#Learn to walk before you run Once#The under-supply of criticism|The under-supply of criticism]]
20. [[#System thinking|System thinking]]
		1. [[#Learn to walk before you run Once#This is what is required to scale back the administrative state.|This is what is required to scale back the administrative state.]]
21. [[#The public policy process|The public policy process]]
		1. [[#Learn to walk before you run Once#The policy pipeline|The policy pipeline]]
22. [[#Do fewer things|Do fewer things]]
23. [[#Rolling up your sleeves to build state capacity”|Rolling up your sleeves to build state capacity”]]
	1. [[#Rolling up your sleeves to build state capacity”#Clarity of purpose of the agent|Clarity of purpose of the agent]]
		1. [[#Clarity of purpose of the agent#Establish a leadership|Establish a leadership]]
				1. [[#thinking across long time horizons#Containing discretion|Containing discretion]]
					1. [[#Containing discretion#Government departments in India are overloaded with many tasks and it is hard to reform this.|Government departments in India are overloaded with many tasks and it is hard to reform this.]]
...
"Where the free market fails to deliver efficient economic outcomes, this is termed **[[Notes/Market_Failure\|Market_Failure]]**'. Market failures come in four kinds:
...
1. [[#Traditional Thinking:|Traditional Thinking:]]
2. [[#Proposed thinking|Proposed thinking]]
...
"A high degree of [[Notes/Asymmetric_Information\|asymmetric information]] can create conditions under which _voluntary or market-based transactions become infeasible_" 
...
- **[[Notes/Asymmetric_Information\|Asymmetric information]]**: The process of negotiation works poorly as there is a lack of information.
...
#RonaldCoase brought fresh insight into this field, with what is called the 'transaction costs perspective' [[Notes/Coase_Theorem\|Coase_Theorem]]
...
The [[Notes/Subsidiarity_Principle\|Subsidiarity_Principle]] asserts that a function should be placed at the lowest level of government where it can possibly be performed
...
System thinking addresses traditional market failures, in the form of [[Notes/Asymmetric_Information\|asymmetric information]], externalities and market power. In fields such as healthcare and pensions, where consumer behaviour may suffer from limited rationality, there is a greater case for system thinking. But it involves a new and daunting level of intrusive intervention, which goes well beyond the main work of public policy."
...
Financial economic policy is about addressing these four objectives: combat negative externalities, combat [[Notes/Asymmetric_Information\|asymmetric information]], invent money, and establish an investment banker for the government.
